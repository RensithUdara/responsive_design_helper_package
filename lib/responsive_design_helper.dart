...
class Responsive {
  ...
  static double responsiveWidth(BuildContext context, double designWidth) {
    return screenWidth(context) * (designWidth / 375); // Assuming 375 is the base design width.
  }
  ...
  static double responsiveHeight(BuildContext context, double designHeight) {
    return screenHeight(context) * (designHeight / 812); // Assuming 812 is the base design height.
  }
